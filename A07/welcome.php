...
<body>
    <div class="welcome-container">
        ...
        <form action="welcome.php" method="POST">
            <button type="submit" name="edit_password" class="btn btn-warning mt-3">Edit Password</button>
        </form>

        <?php if ($show_edit_password_form): ?>
            <!-- Edit Password Form -->
            <form action="welcome.php" method="POST">
                <div>
        ...
        <?php if ($show_password_field): ?>
            <!-- Password Verification Form for Account Deletion -->
            <form action="welcome.php" method="POST">
                <div>
